define(['backbone', 'namespace','utils',)
                    });
                    pending--;
                } 'domReady!'],
    /**
    ...
    function(Backbone, NameSpace, Utils, DOM){
        ...
        NameSpace.InvertedAngledContentView = Backbone.View.extend({
            initialize: function(){
                this.cache = {};
            ...
            draw : function(args){
                ...
                for (var currentWidth = startWidth; currentWidth < endWidth; currentWidth += lengthIncrease) {
                    ...
                    tempSpacerEl.style.float = 'left';
                    tempSpacerEl.style.clear = 'left';
        ...
        return NameSpace.InvertedAngledContentView;
    }
);